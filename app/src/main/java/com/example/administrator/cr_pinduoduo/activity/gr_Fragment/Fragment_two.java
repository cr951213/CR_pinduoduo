...
import com.example.administrator.cr_pinduoduo.activity.adapter.Two_adapter;
...
public class Fragment_two extends Fragment implements One_Iview {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.fg_two, null);
    ...
    public void ShowView(OneBean oneBean) {
        ...
        twoRv.setLayoutManager(manager);
        Two_adapter twoAdapter = new Two_adapter(getActivity(), oneBean);
